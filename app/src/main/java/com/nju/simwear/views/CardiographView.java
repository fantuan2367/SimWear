...
public class CardiographView extends View{
    ...
    //折线的颜色
    protected int mLineColor = Color.parseColor("#f75000");
    //网格颜色
    protected int mGridColor = Color.parseColor("#ff9d6f");
    //小网格颜色
    protected int mSGridColor = Color.parseColor("#ffcbb3");
    //背景颜色
